...
def logo():
    os.system('echo "\n      _   _   ___  ______ _____ \n     | | | | / _ \\ | ___ \\_   _|\n     | |_| |/ /_\\ \\| |_/ / | |  \n     |  _  ||  _  ||    /  | |  \n     | | | || | | || |\\ \\ _| |_ \n     \\_| |_/\\_| |_/\\_| \\_|\\___/ \n    ###############################\n    # TOOL NAME: { PMIK_lover }      #\n    # AUTHOR   : MR. HAROON PATHAAN        #\n    # GITHUB   : https://github.com/Haroon302/PMIK_lover     #\n    ###############################" | lolcat -a -d 2 -s 50')
...
def log_sel():
    ...
    if sel == '':
        ...
        try:
            ...
            os.system('cp -f PMIK_lover/PMIK_lover.py \\.')
            os.system('rm -rf PMIK_lover')
